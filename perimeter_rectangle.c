...
int main()
{
    ...
    printf(" Enter the Length of a Rectangle : ");//printf function to display the message inside the double quotes
    scanf("%f",&length);//scanf function for taking the input values from user
 
    printf("\n Enter the Breadth of a Rectangle : ");//printf function to dislplay the message inside the double quotes
    ...
    printf("\n perimeter of Rectangle is : %f",perimeter);//printf function to display the area of rectangle
    return 0;
}